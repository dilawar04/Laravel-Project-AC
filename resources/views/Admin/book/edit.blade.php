                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="country_of_publisher" id="country_of_publisher" style="width: 100%;">
                      <option value="{{ $book->country_of_publisher }}"> -- Select Country -- </option>
                    </select>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="recomended" id="recomended" style="width: 100%;">
                        <option value="{{ $book->recomended }}">-- Select Recomended --</option>
                      </select>
                    </div>

                    <div class="form-group">
                      <label for="description">Description <span class="text text-red">*</span></label>
                      <textarea class="form-control" name="description" rows="5" id="description" placeholder="Description" value="{{ $book->description }}"></textarea>
                    </div>
                </div>
            </div>
